...
function DailyEnergy(props){
    ...
    return (
        <Box width="150px" height="175px;" bg="teal.500" borderRadius="25px" textAlign={"center"}>
            ...
            { props.isMobile ? <StepperInput onValueChange={props.onValueChange} value={props.spoons} max="12" justifyContent="center"/> : 
            <NumberInputRoot maxW="100px"value={props.spoons} onValueChange={props.onValueChange} margin="auto" max="12">
                <NumberInputField/>
            </NumberInputRoot> }
        </Box>
    )  
