        ...
        <DialogRoot motionPreset="slide-in-bottom" open={open}>
          ...
          <DialogContent>
            ...
            <DialogBody>
                ...
                <Rating icon={<FaUtensilSpoon />} defaultValue="0" value={energy} onClick={e => e.stopPropagation()} onValueChange={(e) => setEnergy(e.value)} count="5"/> 
              
            </DialogBody>
            <DialogFooter>
              <DialogActionTrigger asChild>
                <Button variant="outline" onClick={(e) => handleClicks(e,false)}>Cancel</Button>
              </DialogActionTrigger>
              <Button onClick={e => handleClicks(e, false)}>Save</Button>
            </DialogFooter>
            <DialogCloseTrigger />
          </DialogContent>
        </DialogRoot>
